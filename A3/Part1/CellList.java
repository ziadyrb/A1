 ...
 * 
 *In this program we are making a CellPhone, CellList and CellListUtilzation classes.
 *
 *The CellList class has an inner and outer class. Using single-linked list we
 *made methods to add, delete, replaces and find CellPhone Objects. It will 
